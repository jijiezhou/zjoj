...
declare const Select: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "popupVisible" | "defaultPopupVisible" | "disabled" | "unmountOnClose" | "scrollbar" | "multiple" | "error" | "allowClear" | "defaultValue" | "modelValue" | "loading" | "bordered" | "allowCreate" | "allowSearch" | "maxTagCount" | "defaultInputValue" | "filterOption" | "options" | "searchDelay" | "valueKey" | "defaultActiveFirstOption" | "fallbackOption" | "showExtraOptions" | "limit" | "showHeaderOnEmpty" | "showFooterOnEmpty">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:popupVisible", visible: boolean) => void) & ((event: "popupVisibleChange", visible: boolean) => void) & ((event: "clear", ev: Event) => void) & ((event: "change", value: string | number | boolean | Record<string, any> | (string | number | boolean | Record<string, any>)[]) => void) & ((event: "remove", removed: string | number | boolean | Record<string, any> | undefined) => void) & ((event: "update:modelValue", value: string | number | boolean | Record<string, any> | (string | number | boolean | Record<string, any>)[]) => void) & ((event: "update:inputValue", inputValue: string) => void) & ((event: "inputValueChange", inputValue: string) => void) & ((event: "search", inputValue: string) => void) & ((event: "dropdownScroll", ev: Event) => void) & ((event: "dropdownReachBottom", ev: Event) => void) & ((event: "exceedLimit", value: string | number | boolean | Record<string, any> | undefined, ev: Event) => void);
        $el: any;
