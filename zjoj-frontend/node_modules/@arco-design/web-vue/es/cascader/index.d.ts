...
declare const Cascader: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "popupVisible" | "defaultPopupVisible" | "disabled" | "multiple" | "error" | "allowClear" | "inputValue" | "defaultValue" | "loading" | "allowSearch" | "maxTagCount" | "defaultInputValue" | "checkStrictly" | "options" | "pathMode" | "expandTrigger" | "searchOptionOnlyLabel" | "searchDelay" | "valueKey" | "fallback" | "expandChild">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "popupVisibleChange", visible: boolean) => void) & ((event: "clear") => void) & ((event: "change", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "inputValueChange", value: string) => void) & ((event: "search", value: string) => void);
        $el: any;
