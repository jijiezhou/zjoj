...
declare const TreeSelect: {
    new (...args: any[]): {
        ...
        $emit: ((event: "update:popupVisible", visible: boolean) => void) & ((event: "clear") => void) & ((event: "change", value: string | number | (string | number)[] | import("./interface").LabelValue | import("./interface").LabelValue[] | undefined) => void) & ((event: "update:modelValue", value: string | number | (string | number)[] | import("./interface").LabelValue | import("./interface").LabelValue[] | undefined) => void) & ((event: "search", searchKey: string) => void) & ((event: "popup-visible-change", visible: boolean) => void);
        $el: any;
