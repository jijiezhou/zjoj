...
declare const Radio: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "disabled" | "value" | "modelValue" | "defaultChecked" | "uninjectGroupContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "change", value: string | number | boolean, ev: Event) => void) & ((event: "update:modelValue", value: string | number | boolean) => void);
        $el: any;
