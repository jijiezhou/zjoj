...
declare const Steps: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "small" | "direction" | "lineLess" | "status" | "current" | "defaultCurrent" | "labelPlacement" | "changeable">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
