...
declare const InputTag: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "focused" | "error" | "readonly" | "allowClear" | "defaultValue" | "maxTagCount" | "retainInputValue" | "defaultInputValue" | "uniqueValue" | "disabledInput" | "uninjectFormItemContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "clear", ev: MouseEvent) => void) & ((event: "change", value: (string | number | import("./interface").TagData)[], ev: Event) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "remove", removed: string | number, ev: Event) => void) & ((event: "update:modelValue", value: (string | number | import("./interface").TagData)[]) => void) & ((event: "update:inputValue", inputValue: string) => void) & ((event: "inputValueChange", inputValue: string, ev: Event) => void) & ((event: "pressEnter", inputValue: string, ev: KeyboardEvent) => void);
        $el: any;
