...
declare const ArcoVue: {
    Alter: {
        new (...args: any[]): {
            ...
            } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "center" | "closable" | "showIcon" | "banner">;
            $attrs: {
                [x: string]: unknown;
            };
            $refs: {
    ...
    MenuItem: import("vue").DefineComponent<{
        ...
        menuContext: Partial<Readonly<Pick<import("./menu/interface").InternalMenuProps, "tooltipProps" | "mode" | "triggerProps" | "theme" | "popupMaxHeight" | "levelIndent" | "autoScrollIntoView" | "scrollConfig" | "inTrigger"> & {
            selectedKeys: string[];
            openKeys: string[];
            prefixCls: string;
            collapsed: boolean;
