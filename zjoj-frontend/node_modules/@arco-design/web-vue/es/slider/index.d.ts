...
declare const Slider: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "range" | "defaultValue" | "direction" | "modelValue" | "min" | "max" | "step" | "showTooltip" | "showTicks" | "showInput">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "change", value: number | [number, number]) => void) & ((event: "update:modelValue", value: number | [number, number]) => void);
        $el: any;
