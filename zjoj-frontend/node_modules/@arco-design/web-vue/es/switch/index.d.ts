...
declare const Switch: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "disabled" | "modelValue" | "loading" | "defaultChecked" | "checkedValue" | "uncheckedValue">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "change", value: string | number | boolean, ev: Event) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string | number | boolean) => void);
        $el: any;
